const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "VladAI can work with many LLM providers. This will be the service which handles chatting.",
    },
    userSetup: {
      title: "User Setup",
    ...
    survey: {
      title: "Welcome to VladAI",
      description: "Help us make VladAI built for your needs. Optional.",

      email: "What's your email?",
      useCase: "What will you use VladAI for?",
      useCaseWork: "For work",
      useCasePersonal: "For personal use",
      useCaseOther: "Other",
      comment: "How did you hear about VladAI?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "Create your first workspace and get started with VladAI.",
    },
  },
  common: {
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "You're on your way to becoming a VladAI expert!",
      dismiss: "close",
      tasks: {
        create_workspace: {
  ...
  customization: {
    interface: {
      ...
      description: "Set your UI preferences for VladAI.",
    },
    branding: {
      title: "Branding & Whitelabeling",
      description:
        "White-label your VladAI instance with custom branding.",
    },
    chat: {
      title: "Chat",
      description: "Set your chat preferences for VladAI.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Select the preferred language to render VladAI's UI in - when translations are available.",
      },
      logo: {
        title: "Brand Logo",
      ...
      "welcome-messages": {
        ...
        user: "user",
        message: "message",
        assistant: "VladAI Chat Assistant",
  ...
  api: {
    title: "API Keys",
    description:
      "API keys allow the holder to programmatically access and manage this VladAI instance.",
  ...
  llm: {
    title: "LLM Preference",
    description:
      "These are the credentials and settings for your preferred LLM chat & embedding provider. It is important that these keys are current and correct, or else VladAI will not function properly.",
  ...
  transcription: {
    ...
    "warn-start":
      "Using the local whisper model on machines with limited RAM or CPU can stall VladAI when processing media files.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding is the process of turning text into vectors. These credentials are required to turn your files and prompts into a format which VladAI can use to process.",
    provider: {
  ...
  vector: {
    ...
    description:
      "These are the credentials and settings for how your VladAI instance will function. It's important these keys are current and correct.",
    provider: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protect your VladAI instance with a password. If you forget this there is no recovery method so ensure you save this password.",
  ...
  privacy: {
    ...
    description:
      "This is your configuration for how connected third party providers and VladAI handle your data.",
    llm: "LLM Selection",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "These files will be uploaded to the document processor running on this VladAI instance. These files are not sent or shared with a third party.",
    },
    pinning: {
      what_pinning: "What is document pinning?",
      pin_explained_block1:
        "When you <b>pin</b> a document in VladAI we will inject the entire content of the document into your prompt window for your LLM to fully comprehend.",
      pin_explained_block2:
        "This works best with <b>large-context models</b> or small files that are critical to its knowledge-base.",
      pin_explained_block3:
        "If you are not getting the answers you desire from VladAI by default then pinning is a great way to get higher quality answers in a click.",
      accept: "Okay, got it",
    },
    watching: {
      what_watching: "What does watching a document do?",
      watch_explained_block1:
        "When you <b>watch</b> a document in VladAI we will <i>automatically</i> sync your document content from it's original source on regular intervals. This will automatically update the content in every workspace where this file is managed.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "You need to authenticate with the VladAI Community Hub before publishing items.",
